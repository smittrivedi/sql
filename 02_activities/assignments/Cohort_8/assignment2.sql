...
customer_count AS (
    SELECT COUNT(*) AS total_customers FROM customer_purchases
)
SELECT 
    vp.vendor_name,
    vp.product_name,
    (cc.total_customers * 5 * vp.original_price) AS total_revenue
...
VALUES (
    999,  -- Example new product_id
    'Apple Pie',  -- Product name
    '9 inch',  -- Product size
    3,  -- Example category ID (adjust based on your schema)
    'unit',  -- Quantity type
